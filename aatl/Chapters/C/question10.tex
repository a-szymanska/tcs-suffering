Algorytm Grovera to kwantowy algorytm wyszukiwania, czyli dla zdefiniowanej funkcji \( f : \set{0, 1, \ldots, N - 1} \rightarrow \set{0, 1} \) taką, że dla dokładnie jednego \( x* \) funkcja \( f \) przyjmuje wartość 1,
